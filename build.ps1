Remove-Item –path ./cloudmersive_documentai_api_client –recurse
...
(Get-Content ./cloudmersive_documentai_api_client/api_client.py).replace('if response_type:', $newcontent) | Set-Content ./cloudmersive_documentai_api_client/api_client.py
(Get-Content ./cloudmersive_documentai_api_client/rest.py).replace((Get-Content ./core/rest_match.py -Raw), (Get-Content ./core/rest_replace.py -Raw)) | Set-Content ./cloudmersive_documentai_api_client/rest.py
...
(Get-Content ./setup.py).replace('Use next-generation AI to extract data, fields, insights and text from documents. Instantly.  # noqa: E501', '') | Set-Content ./setup.py

(Get-Content ./setup.py).replace('    """', '') | Set-Content ./setup.py
(Get-Content ./README.md).replace('This Python package is automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project:', 'This Python package provides a native API client for [Cloudmersive Document AI API](https://cloudmersive.com/document-ai-api)') | Set-Content ./README.md
Write-Host "Done."