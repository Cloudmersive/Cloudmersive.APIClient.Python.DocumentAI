...
class TableResultRow(object):
    ...
    def __init__(self, cells=None):  # noqa: E501
        """TableResultRow - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def cells(self):
        """Gets the cells of this TableResultRow.  # noqa: E501

        Cells in the row  # noqa: E501

        :return: The cells of this TableResultRow.  # noqa: E501
        :rtype: list[TableResultCell]
        """
        return self._cells

    @cells.setter
    def cells(self, cells):
        """Sets the cells of this TableResultRow.

        Cells in the row  # noqa: E501

        :param cells: The cells of this TableResultRow.  # noqa: E501
        :type: list[TableResultCell]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TableResultRow, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TableResultRow):
            return False
